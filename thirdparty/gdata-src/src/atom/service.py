...
class AtomService(object):
  ...
  def Get(self, uri, extra_headers=None, url_params=None, escape_params=True):
    ...
    Returns:
      HTTPResponse The server's response to the GET request.
    """
  ...
  def Post(self, data, uri, extra_headers=None, url_params=None, 
    ...
    Returns:
      HTTPResponse Server's response to the POST request.
    """
  ...
  def Put(self, data, uri, extra_headers=None, url_params=None, 
    ...
    Returns:
      HTTPResponse Server's response to the PUT request.
    """
    if extra_headers is None:
      extra_headers = {}
    if content_type:
  ...
  def Delete(self, uri, extra_headers=None, url_params=None, 
    ...
    Returns:
      HTTPResponse Server's response to the DELETE request.
    """
...
def PrepareConnection(service, full_uri):
  ...
  Returns:
    A tuple containing the HTTPConnection and the full_uri for the
    request.
  """
  ...
  if ssl:
    ...
    if proxy:
      ...
      connection.sock=ssl_obj
      full_uri = partial_uri

    else:
      connection = HTTPSConnection(server, port)
      full_uri = partial_uri
    ...
    if proxy:
      ...
      connection = HTTPConnection(p_server, p_port)
...
def HttpRequest(service, operation, data, uri, extra_headers=None, 
  ...
  # If the list of headers does not include a Content-Length, attempt to 
  # calculate it based on the data object.
  if (data and not 'Content-Length' in service.additional_headers and 
      not 'Content-Length' in extra_headers):
    content_length = CalculateDataLength(data)
    if content_length:
