...
class RenderingControl3ServiceProxy(UpnpServiceProxy, LoadableExtension):
    ...
    SERVICE_ID = 'urn:schemas-upnp-org:service:RenderingControl'


    def get_AllowedDefaultTransformSettings(self):
        """
            Gets the "AllowedDefaultTransformSettings" variable.
        """
        rval = self.proxy_get_variable_value("AllowedDefaultTransformSettings")
        return rval


    def set_AllowedDefaultTransformSettings(self, val):
        """
            Sets the "AllowedDefaultTransformSettings" variable.
        """
        self.proxy_set_variable_value("AllowedDefaultTransformSettings", val)
        return


    def get_AllowedTransformSettings(self):
        """
            Gets the "AllowedTransformSettings" variable.
        """
        rval = self.proxy_get_variable_value("AllowedTransformSettings")
        return rval


    def set_AllowedTransformSettings(self, val):
        """
            Sets the "AllowedTransformSettings" variable.
        """
        self.proxy_set_variable_value("AllowedTransformSettings", val)
        return
    ...
    def get_DefaultTransformSettings(self):
        """
            Gets the "DefaultTransformSettings" variable.
        """
        rval = self.proxy_get_variable_value("DefaultTransformSettings")
        return rval


    def set_DefaultTransformSettings(self, val):
        """
            Sets the "DefaultTransformSettings" variable.
        """
        self.proxy_set_variable_value("DefaultTransformSettings", val)
        return
    ...
    def get_TransformSettings(self):
        """
            Gets the "TransformSettings" variable.
        """
        rval = self.proxy_get_variable_value("TransformSettings")
        return rval


    def set_TransformSettings(self, val):
        """
            Sets the "TransformSettings" variable.
        """
        self.proxy_set_variable_value("TransformSettings", val)
        return
    ...
    def action_GetAllAvailableTransforms(self):
        ...
        (AllAllowedTransformSettings,) = out_params

        return AllAllowedTransformSettings


    def action_GetAllowedDefaultTransforms(self):
        """
            Calls the GetAllowedDefaultTransforms action.
        """
        arguments = { }

        out_params = self.proxy_call_action("GetAllowedDefaultTransforms", arguments=arguments)

        (AllowedDefaultTransformSettings,) = out_params

        return AllowedDefaultTransformSettings


    def action_GetAllowedTransforms(self, InstanceID):
        """
        ...
        (CurrentAllowedTransformSettings,) = out_params

        return CurrentAllowedTransformSettings
    ...
    def action_GetDefaultTransforms(self):
        """
            Calls the GetDefaultTransforms action.
        """
        arguments = { }

        out_params = self.proxy_call_action("GetDefaultTransforms", arguments=arguments)

        (CurrentDefaultTransformSettings,) = out_params

        return CurrentDefaultTransformSettings
    ...
    def action_GetTransforms(self, InstanceID):
        """
        ...
        (CurrentTransformValues,) = out_params

        return CurrentTransformValues
    ...
    def action_SetDefaultTransforms(self, DesiredDefaultTransformSettings):
        ...
        out_params = self.proxy_call_action("SetDefaultTransforms", arguments=arguments)
    ...
    def action_SetTransforms(self, InstanceID, DesiredTransformValues):
        ...
        out_params = self.proxy_call_action("SetTransforms", arguments=arguments)
