...
class DigitalSecurityCameraMotionImageServiceProxy(UpnpServiceProxy, LoadableExtension):
    """
        This is a code generated proxy class to the 'DigitalSecurityCameraMotionImage' service.
    """
    ...
    def get_MaxBandwidth(self):
        """
            Gets the "MaxBandwidth" variable.
        """
        rval = self.proxy_get_variable_value("MaxBandwidth")
        return rval


    def set_MaxBandwidth(self, val):
        """
            Sets the "MaxBandwidth" variable.
        """
        self.proxy_set_variable_value("MaxBandwidth", val)
        return


    def get_TargetFrameRate(self):
        """
            Gets the "TargetFrameRate" variable.
        """
        rval = self.proxy_get_variable_value("TargetFrameRate")
        return rval


    def set_TargetFrameRate(self, val):
        """
            Sets the "TargetFrameRate" variable.
        """
        self.proxy_set_variable_value("TargetFrameRate", val)
        return


    def get_VideoPresentationURL(self):
        """
            Gets the "VideoPresentationURL" variable.
        """
        rval = self.proxy_get_variable_value("VideoPresentationURL")
        return rval


    def set_VideoPresentationURL(self, val):
        """
            Sets the "VideoPresentationURL" variable.
        """
        self.proxy_set_variable_value("VideoPresentationURL", val)
        return


    def get_VideoURL(self):
        """
            Gets the "VideoURL" variable.
        """
        rval = self.proxy_get_variable_value("VideoURL")
        return rval


    def set_VideoURL(self, val):
        """
            Sets the "VideoURL" variable.
        """
        self.proxy_set_variable_value("VideoURL", val)
        return
    ...
    def action_GetDefaultVideoPresentationURL(self):
        """
            Calls the GetDefaultVideoPresentationURL action.
        """
        arguments = { }

        out_params = self.proxy_call_action("GetDefaultVideoPresentationURL", arguments=arguments)

        (RetVideoPresentationURL,) = out_params

        return RetVideoPresentationURL


    def action_GetDefaultVideoURL(self):
        """
            Calls the GetDefaultVideoURL action.
        """
        arguments = { }

        out_params = self.proxy_call_action("GetDefaultVideoURL", arguments=arguments)

        (RetVideoURL,) = out_params

        return RetVideoURL


    def action_GetMaxBandwidth(self):
        """
            Calls the GetMaxBandwidth action.
        """
        arguments = { }

        out_params = self.proxy_call_action("GetMaxBandwidth", arguments=arguments)

        (RetMaxBandwidth,) = out_params

        return RetMaxBandwidth


    def action_GetTargetFrameRate(self):
        """
            Calls the GetTargetFrameRate action.
        """
        arguments = { }

        out_params = self.proxy_call_action("GetTargetFrameRate", arguments=arguments)

        (RetTargetFrameRate,) = out_params

        return RetTargetFrameRate


    def action_GetVideoPresentationURL(self, ReqEncoding, ReqCompression, ReqResolution):
        """
        ...
        out_params = self.proxy_call_action("GetVideoPresentationURL", arguments=arguments)
    ...
    def action_GetVideoURL(self, ReqEncoding, ReqCompression, ReqResolution):
        """
        ...
        out_params = self.proxy_call_action("GetVideoURL", arguments=arguments)
    ...
    def action_SetMaxBandwidth(self, ReqMaxBandwidth):
        ...
        out_params = self.proxy_call_action("SetMaxBandwidth", arguments=arguments)
    ...
    def action_SetTargetFrameRate(self, ReqTargetFrameRate):
        ...
        out_params = self.proxy_call_action("SetTargetFrameRate", arguments=arguments)
