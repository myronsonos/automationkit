...
class DigitalSecurityCameraStillImageServiceProxy(UpnpServiceProxy, LoadableExtension):
    """
        This is a code generated proxy class to the 'DigitalSecurityCameraStillImage' service.
    """

    SERVICE_TYPE = 'urn:schemas-upnp-org:service:DigitalSecurityCameraStillImage:1'
    SERVICE_NAME = 'urn:schemas-upnp-org:service:DigitalSecurityCameraStillImage'
