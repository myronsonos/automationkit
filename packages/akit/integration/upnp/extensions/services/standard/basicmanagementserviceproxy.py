...
class BasicManagementServiceProxy(UpnpServiceProxy, LoadableExtension):
    """
        This is a code generated proxy class to the 'BasicManagement' service.
    """
    ...
    def get_TestIDs(self):
        """
            Gets the "TestIDs" variable.
        """
        rval = self.proxy_get_variable_value("TestIDs")
        return rval


    def set_TestIDs(self, val):
        """
            Sets the "TestIDs" variable.
        """
        self.proxy_set_variable_value("TestIDs", val)
        return


    def action_BandwidthTest(self, BandwidthTestSpec, TestEndpoint, TestSchedule, TestSessID):
        """
    ...
    def action_GetBandwidthTestInfo(self):
        """
        ...
        (BandwidthTestInfo,) = out_params

        return BandwidthTestInfo


    def action_GetBandwidthTestResult(self, TestID):
        """
        ...
        (State, Status, AdditionalInfo, Result,) = out_params

        return State, Status, AdditionalInfo, Result
