...
class LinkAuthenticationServiceProxy(UpnpServiceProxy, LoadableExtension):
    """
        This is a code generated proxy class to the 'LinkAuthentication' service.
    """

    SERVICE_TYPE = 'urn:schemas-upnp-org:service:LinkAuthentication:1'
    SERVICE_NAME = 'urn:schemas-upnp-org:service:LinkAuthentication'
