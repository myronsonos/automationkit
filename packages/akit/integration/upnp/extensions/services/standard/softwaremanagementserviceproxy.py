...
class SoftwareManagementServiceProxy(UpnpServiceProxy, LoadableExtension):
    """
        This is a code generated proxy class to the 'SoftwareManagement' service.
    """
    ...
    def action_GetEUInfo(self, EUID):
        ...
        (EUName, EUVersion, EURequestedState, EURunningState,) = out_params

        return EUName, EUVersion, EURequestedState, EURunningState
