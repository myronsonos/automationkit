...
class TemperatureSensorServiceProxy(UpnpServiceProxy, LoadableExtension):
    """
        This is a code generated proxy class to the 'TemperatureSensor' service.
    """

    SERVICE_TYPE = 'urn:schemas-upnp-org:service:TemperatureSensor:1'
    SERVICE_NAME = 'urn:schemas-upnp-org:service:TemperatureSensor'
