...
class DimmingServiceProxy(UpnpServiceProxy, LoadableExtension):
    """
        This is a code generated proxy class to the 'Dimming' service.
    """

    SERVICE_TYPE = 'urn:schemas-upnp-org:service:Dimming:1'
    SERVICE_NAME = 'urn:schemas-upnp-org:service:Dimming'
