...
class HVAC_SetpointScheduleServiceProxy(UpnpServiceProxy, LoadableExtension):
    """
        This is a code generated proxy class to the 'HVAC_SetpointSchedule' service.
    """

    SERVICE_TYPE = 'urn:schemas-upnp-org:service:HVAC_SetpointSchedule:1'
    SERVICE_NAME = 'urn:schemas-upnp-org:service:HVAC_SetpointSchedule'
