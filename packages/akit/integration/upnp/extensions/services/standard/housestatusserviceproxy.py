...
class HouseStatusServiceProxy(UpnpServiceProxy, LoadableExtension):
    """
        This is a code generated proxy class to the 'HouseStatus' service.
    """

    SERVICE_TYPE = 'urn:schemas-upnp-org:service:HouseStatus:1'
    SERVICE_NAME = 'urn:schemas-upnp-org:service:HouseStatus'
